...
const Hero = ({ theme }) => {
  return (
    <section id="home" className="w-full h-auto md:h-[550px] px-6 md:px-[70px] py-[50px] my-[70px] flex flex-col md:flex-row items-center justify-between text-primary dark:text-white bg-white dark:bg-gray-900 relative overflow-hidden"
      style={{ backgroundImage: `url('${img('Vector 3.svg')}'), url('${img('Vector 1.svg')}')`, backgroundRepeat: 'no-repeat', backgroundPosition: 'bottom' }}>
      ...
      <motion.div
        ...
        style={{ backgroundImage: `url('${img('Blur Gradient.png')}')`, backgroundRepeat: 'no-repeat' }}>
        ...
        <a href={img('CV.pdf')} download className="bg-white/60 mt-6 md:mt-[30px] px-6 py-3 rounded-lg w-fit text-primary dark:text-white hover:bg-primary hover:text-white dark:hover:bg-white dark:hover:text-gray-900 transition-all duration-300">
          Download CV
        </a>
      </motion.div>
